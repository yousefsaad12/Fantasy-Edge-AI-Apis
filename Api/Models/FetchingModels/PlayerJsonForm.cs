...
namespace Api.Models.FetchingModels
{
    public class PlayerJsonForm
    {
        ...
        public int expected_goals_per_90 { get; set; }
        public int saves_per_90 { get; set; }
        public int expected_assists_per_90 { get; set; }
        public int expected_goal_involvements_per_90 { get; set; }
        public int expected_goals_conceded_per_90 { get; set; }
        public int goals_conceded_per_90 { get; set; }
        ...
        public int starts_per_90 { get; set; }
        public int clean_sheets_per_90 { get; set; }
    }
}